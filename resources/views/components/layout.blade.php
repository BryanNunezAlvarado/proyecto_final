    ...
    <div class="footer">
        <div class="container">
                ...
                <div class="footer-bottom">
                    ...
                    <div class=" address">
                        <div class="col-md-4 fo-grid1">
                                <p><i class="fa fa-home" aria-hidden="true"></i>Blvd. Gral. Marcelino García Barragán 1421, Olímpica, 44430 Guadalajara, Jal.</p>
                        </div>
                        <div class="col-md-4 fo-grid1">
            ...
            <div class="copy-right">
                <p> &copy; 2022 BL store. Derechos Reservados| Design by Luis Eduardo Vazquez Rodriguez & Bryan Daniel Nuñez Alvarado</a></p>
            </div>
        </div>
    </div>
    <!-- tabs -->
